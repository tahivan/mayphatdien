            ...
            onSuccess: function(transport) {
                try {
                    ...
                    if (targetEl.tagName.toLowerCase() == 'input') {
                        ...
                        if(targetEl.tagName.toLowerCase() =='label')
                        {
                            var inputFiledID = this.targetElementId.replace('label','value');
                            targetEl.innerHTML = transport.responseText;
                            document.getElementById(inputFiledID).value = transport.responseText;
